 ...
 */
class Version20180219134815 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE period ADD period_type_id INT DEFAULT NULL, DROP type, CHANGE project_id project_id INT DEFAULT NULL, ADD PRIMARY KEY (start)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE period ADD type VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP period_type_id, CHANGE project_id project_id INT NOT NULL');
    }
}
